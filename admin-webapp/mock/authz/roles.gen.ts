...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Admin", grants: ["assets:manage", "assets:read-all", "guest-accounts:manage", "requests:manage", "requests:read-all"] },
  { name: "Guest", grants: ["assets:read", "requests:read", "requests:submit"] },
];
